...
public interface ICrudSrv<VO extends IBaseDTO, ID extends Serializable> {
  /**
   * 保存单个实体
   *
   * @param vo 实体
  ...
  default IBmfResult<VO> save(VO vo) {
    throw new BmfException("This method shoud be implemented in subclass.");
  }
   ...
   * @param id 主键
   */
  default IBmfResult<?> delete(ID id) {
    throw new BmfException("This method shoud be implemented in subclass.");
  }
   ...
   * @param vo 实体
   */
  default IBmfResult<?> delete(VO vo) {
    throw new BmfException("This method shoud be implemented in subclass.");
  }
   ...
   * @param ids 实体
   */
  default IBmfResult<?> delete(ID[] ids) {
    throw new BmfException("This method shoud be implemented in subclass.");
  }
   ...
   * @return
   */
  default IBmfResult<PageResultDTO> findAll(PageParamDTO pageParamDTO) {
    throw new BmfException("This method shoud be implemented in subclass.");
  }
   ...
   * @return
   */
 /* default List<VO> findAll(Sort sort) {
    throw new BmfException("This method shoud be implemented in subclass.");
  }
*/
  /**
